...
├─ Business logic → Passistant.Domain or [Project].Domain
├─ Use case orchestration → Passistant.Application or [Project].Application
├─ Database/API concerns → Passistant.Infrastructure.* or [Project].Data/Api
├─ Cross-cutting utilities → Passistant.Common
└─ Presentation/UI → [Project].Api or Passistant.Web
```
